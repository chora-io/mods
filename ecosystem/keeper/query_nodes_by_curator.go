...
func (k Keeper) NodesByCurator(ctx context.Context, req *v1.QueryNodesByCuratorRequest) (*v1.QueryNodesByCuratorResponse, error) {
	...
	index := ecosystemv1.NodeCuratorIndexKey{}.WithCurator(curator)

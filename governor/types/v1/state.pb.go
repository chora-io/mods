...
func (m *Governor) GetGovernor() string {
	if m != nil {
		return m.Governor
	}
	return ""
...
var fileDescriptor_8a431de71a1c4e75 = []byte{
	...
	0xaa, 0xf3, 0x8b, 0x72, 0x21, 0x6a, 0x95, 0x22, 0xb8, 0x38, 0xdc, 0xa1, 0xea, 0x84, 0xa4, 0xb8,
	0x38, 0x60, 0x7a, 0x24, 0x18, 0x15, 0x18, 0x35, 0x38, 0x83, 0xe0, 0x7c, 0x90, 0x5c, 0x6e, 0x6a,
	0x49, 0x62, 0x4a, 0x62, 0x49, 0xa2, 0x04, 0x13, 0x44, 0x0e, 0xc6, 0xb7, 0x12, 0xf9, 0x34, 0xef,
	0x72, 0x1f, 0x33, 0x1f, 0x17, 0x17, 0x92, 0x7e, 0x26, 0x27, 0x97, 0x13, 0x8f, 0xe4, 0x18, 0x2f,
	...
	0xd5, 0x07, 0x3b, 0x55, 0x37, 0x33, 0x5f, 0x3f, 0x37, 0x3f, 0xa5, 0x18, 0xe1, 0xa3, 0x92, 0xca,
	0x82, 0xd4, 0x62, 0xfd, 0x32, 0xc3, 0x24, 0x36, 0xb0, 0x33, 0x8d, 0x01, 0x01, 0x00, 0x00, 0xff,
	0xff, 0x64, 0xfd, 0xca, 0xcf, 0xf3, 0x00, 0x00, 0x00,
}
...
func (m *Governor) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Governor) > 0 {
		...
		i = encodeVarintState(dAtA, i, uint64(len(m.Governor)))
		i--
		dAtA[i] = 0xa
	}

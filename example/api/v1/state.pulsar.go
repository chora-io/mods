...
func (x *fastReflection_Content) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "chora.example.v1.Content.creator":
		panic(fmt.Errorf("field creator of message chora.example.v1.Content is not mutable"))
	case "chora.example.v1.Content.hash":
		panic(fmt.Errorf("field hash of message chora.example.v1.Content is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: chora.example.v1.Content"))
		}
...
func (x *Content) GetCreator() []byte {
	if x != nil {
		return x.Creator
	}
	return nil

...
func init() {
	file_chora_example_v1_state_proto_init()
	md_Content = File_chora_example_v1_state_proto.Messages().ByName("Content")
...
func (x *Content) slowProtoReflect() protoreflect.Message {
	mi := &file_chora_example_v1_state_proto_msgTypes[0]
...
func (x *fastReflection_Content) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "chora.example.v1.Content.curator":
		return len(x.Curator) != 0
	case "chora.example.v1.Content.metadata":
		return x.Metadata != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: chora.example.v1.Content"))
		}
		panic(fmt.Errorf("message chora.example.v1.Content does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_Content) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message chora.example.v1.Content does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_Content) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "chora.example.v1.Content.curator":
		panic(fmt.Errorf("field curator of message chora.example.v1.Content is not mutable"))
	case "chora.example.v1.Content.metadata":
		panic(fmt.Errorf("field metadata of message chora.example.v1.Content is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: chora.example.v1.Content"))
		}
...
func (x *fastReflection_Content) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in chora.example.v1.Content", d.FullName()))
	}
	panic("unreachable")
}
...
// 	protoc        (unknown)
// source: chora/example/v1/state.proto
...
func (*Content) Descriptor() ([]byte, []int) {
	return file_chora_example_v1_state_proto_rawDescGZIP(), []int{0}
}
...
var File_chora_example_v1_state_proto protoreflect.FileDescriptor

var file_chora_example_v1_state_proto_rawDesc = []byte{
	...
	0x6d, 0x2e, 0x63, 0x68, 0x6f, 0x72, 0x61, 0x2e, 0x65, 0x78, 0x61, 0x6d, 0x70, 0x6c, 0x65, 0x2e,
	...
	,
}

var (
	file_chora_example_v1_state_proto_rawDescOnce sync.Once
	file_chora_example_v1_state_proto_rawDescData = file_chora_example_v1_state_proto_rawDesc
)

func file_chora_example_v1_state_proto_rawDescGZIP() []byte {
	file_chora_example_v1_state_proto_rawDescOnce.Do(func() {
		file_chora_example_v1_state_proto_rawDescData = protoimpl.X.CompressGZIP(file_chora_example_v1_state_proto_rawDescData)
	})
	return file_chora_example_v1_state_proto_rawDescData
}

var file_chora_example_v1_state_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_chora_example_v1_state_proto_goTypes = []interface{}{
	(*Content)(nil), // 0: chora.example.v1.Content
}
var file_chora_example_v1_state_proto_depIdxs = []int32{
...
func init() { file_chora_example_v1_state_proto_init() }
func file_chora_example_v1_state_proto_init() {
	if File_chora_example_v1_state_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_chora_example_v1_state_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_chora_example_v1_state_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_chora_example_v1_state_proto_goTypes,
		DependencyIndexes: file_chora_example_v1_state_proto_depIdxs,
		MessageInfos:      file_chora_example_v1_state_proto_msgTypes,
	}.Build()
	File_chora_example_v1_state_proto = out.File
	file_chora_example_v1_state_proto_rawDesc = nil
	file_chora_example_v1_state_proto_goTypes = nil
	file_chora_example_v1_state_proto_depIdxs = nil
}

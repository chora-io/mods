Feature: MsgUpdateSubjectSteward
  ...
  Scenario: an error is returned if new steward is empty
    Given message
    """
    {
      "address": "chora1r05jctvye5rweu4f6n3gle0ycaww6xpueccqpy63erz75gfy3p7snu2hw4",
  ...
  Scenario: an error is returned if new steward is not a bech32 address
    Given message
    """
    {
      "address": "chora1r05jctvye5rweu4f6n3gle0ycaww6xpueccqpy63erz75gfy3p7snu2hw4",

...
func init() {
	file_chora_validator_v1_query_proto_init()
	md_QueryValidatorRequest = File_chora_validator_v1_query_proto.Messages().ByName("QueryValidatorRequest")
...
func (x *QueryValidatorRequest) slowProtoReflect() protoreflect.Message {
	mi := &file_chora_validator_v1_query_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_QueryValidatorRequest) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "chora.validator.v1.QueryValidatorRequest.address":
		return x.Address != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: chora.validator.v1.QueryValidatorRequest"))
		}
		panic(fmt.Errorf("message chora.validator.v1.QueryValidatorRequest does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_QueryValidatorRequest) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message chora.validator.v1.QueryValidatorRequest does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_QueryValidatorRequest) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "chora.validator.v1.QueryValidatorRequest.address":
		panic(fmt.Errorf("field address of message chora.validator.v1.QueryValidatorRequest is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: chora.validator.v1.QueryValidatorRequest"))
		}
...
func (x *fastReflection_QueryValidatorRequest) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in chora.validator.v1.QueryValidatorRequest", d.FullName()))
	}
	panic("unreachable")
}
...
var (
	...
	fd_QueryValidatorResponse_address       protoreflect.FieldDescriptor
	fd_QueryValidatorResponse_metadata      protoreflect.FieldDescriptor
	fd_QueryValidatorResponse_missed_blocks protoreflect.FieldDescriptor
)

func init() {
	file_chora_validator_v1_query_proto_init()
	md_QueryValidatorResponse = File_chora_validator_v1_query_proto.Messages().ByName("QueryValidatorResponse")
	fd_QueryValidatorResponse_address = md_QueryValidatorResponse.Fields().ByName("address")
	fd_QueryValidatorResponse_metadata = md_QueryValidatorResponse.Fields().ByName("metadata")
	fd_QueryValidatorResponse_missed_blocks = md_QueryValidatorResponse.Fields().ByName("missed_blocks")
}
...
func (x *QueryValidatorResponse) slowProtoReflect() protoreflect.Message {
	mi := &file_chora_validator_v1_query_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_QueryValidatorResponse) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.Address != "" {
		value := protoreflect.ValueOfString(x.Address)
		if !f(fd_QueryValidatorResponse_address, value) {
			return
		}
	}
	if x.Metadata != "" {
		value := protoreflect.ValueOfString(x.Metadata)
		if !f(fd_QueryValidatorResponse_metadata, value) {
			return
		}
	}
	if x.MissedBlocks != int64(0) {
		value := protoreflect.ValueOfInt64(x.MissedBlocks)
		if !f(fd_QueryValidatorResponse_missed_blocks, value) {
			return
		}
	}
}
...
func (x *fastReflection_QueryValidatorResponse) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "chora.validator.v1.QueryValidatorResponse.address":
		return x.Address != ""
	case "chora.validator.v1.QueryValidatorResponse.metadata":
		return x.Metadata != ""
	case "chora.validator.v1.QueryValidatorResponse.missed_blocks":
		return x.MissedBlocks != int64(0)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: chora.validator.v1.QueryValidatorResponse"))
		}
		panic(fmt.Errorf("message chora.validator.v1.QueryValidatorResponse does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_QueryValidatorResponse) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message chora.validator.v1.QueryValidatorResponse does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_QueryValidatorResponse) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "chora.validator.v1.QueryValidatorResponse.address":
		panic(fmt.Errorf("field address of message chora.validator.v1.QueryValidatorResponse is not mutable"))
	case "chora.validator.v1.QueryValidatorResponse.metadata":
		panic(fmt.Errorf("field metadata of message chora.validator.v1.QueryValidatorResponse is not mutable"))
	case "chora.validator.v1.QueryValidatorResponse.missed_blocks":
		panic(fmt.Errorf("field missed_blocks of message chora.validator.v1.QueryValidatorResponse is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: chora.validator.v1.QueryValidatorResponse"))
		}
...
func (x *fastReflection_QueryValidatorResponse) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in chora.validator.v1.QueryValidatorResponse", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_chora_validator_v1_query_proto_init()
	md_QueryValidatorsRequest = File_chora_validator_v1_query_proto.Messages().ByName("QueryValidatorsRequest")
...
func (x *QueryValidatorsRequest) slowProtoReflect() protoreflect.Message {
	mi := &file_chora_validator_v1_query_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_QueryValidatorsRequest) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "chora.validator.v1.QueryValidatorsRequest.pagination":
		return x.Pagination != nil
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: chora.validator.v1.QueryValidatorsRequest"))
		}
		panic(fmt.Errorf("message chora.validator.v1.QueryValidatorsRequest does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_QueryValidatorsRequest) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message chora.validator.v1.QueryValidatorsRequest does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_QueryValidatorsRequest) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in chora.validator.v1.QueryValidatorsRequest", d.FullName()))
	}
	panic("unreachable")
}
...
type _QueryValidatorsResponse_1_list struct {
	list *[]*QueryValidatorsResponse_Validator
}
...
func (x *_QueryValidatorsResponse_1_list) Set(i int, value protoreflect.Value) {
	...
	concreteValue := valueUnwrapped.Interface().(*QueryValidatorsResponse_Validator)
...
func (x *_QueryValidatorsResponse_1_list) AppendMutable() protoreflect.Value {
	v := new(QueryValidatorsResponse_Validator)
...
func init() {
	file_chora_validator_v1_query_proto_init()
	md_QueryValidatorsResponse = File_chora_validator_v1_query_proto.Messages().ByName("QueryValidatorsResponse")
...
func (x *QueryValidatorsResponse) slowProtoReflect() protoreflect.Message {
	mi := &file_chora_validator_v1_query_proto_msgTypes[5]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_QueryValidatorsResponse) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "chora.validator.v1.QueryValidatorsResponse.validators":
		return len(x.Validators) != 0
	case "chora.validator.v1.QueryValidatorsResponse.pagination":
		return x.Pagination != nil
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: chora.validator.v1.QueryValidatorsResponse"))
		}
		panic(fmt.Errorf("message chora.validator.v1.QueryValidatorsResponse does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_QueryValidatorsResponse) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message chora.validator.v1.QueryValidatorsResponse does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_QueryValidatorsResponse) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "chora.validator.v1.QueryValidatorsResponse.validators":
		if x.Validators == nil {
			x.Validators = []*QueryValidatorsResponse_Validator{}
		}
...
func (x *fastReflection_QueryValidatorsResponse) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in chora.validator.v1.QueryValidatorsResponse", d.FullName()))
	}
	panic("unreachable")
}
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 1:
				...
				x.Validators = append(x.Validators, &QueryValidatorsResponse_Validator{})
...
var (
	md_QueryValidatorsResponse_Validator               protoreflect.MessageDescriptor
	fd_QueryValidatorsResponse_Validator_address       protoreflect.FieldDescriptor
	fd_QueryValidatorsResponse_Validator_metadata      protoreflect.FieldDescriptor
	fd_QueryValidatorsResponse_Validator_missed_blocks protoreflect.FieldDescriptor
)

func init() {
	file_chora_validator_v1_query_proto_init()
	md_QueryValidatorsResponse_Validator = File_chora_validator_v1_query_proto.Messages().ByName("QueryValidatorsResponse").Messages().ByName("Validator")
	fd_QueryValidatorsResponse_Validator_address = md_QueryValidatorsResponse_Validator.Fields().ByName("address")
	fd_QueryValidatorsResponse_Validator_metadata = md_QueryValidatorsResponse_Validator.Fields().ByName("metadata")
	fd_QueryValidatorsResponse_Validator_missed_blocks = md_QueryValidatorsResponse_Validator.Fields().ByName("missed_blocks")
}

var _ protoreflect.Message = (*fastReflection_QueryValidatorsResponse_Validator)(nil)

type fastReflection_QueryValidatorsResponse_Validator QueryValidatorsResponse_Validator

func (x *QueryValidatorsResponse_Validator) ProtoReflect() protoreflect.Message {
	return (*fastReflection_QueryValidatorsResponse_Validator)(x)
}

func (x *QueryValidatorsResponse_Validator) slowProtoReflect() protoreflect.Message {
	mi := &file_chora_validator_v1_query_proto_msgTypes[6]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
var _fastReflection_QueryValidatorsResponse_Validator_messageType fastReflection_QueryValidatorsResponse_Validator_messageType
var _ protoreflect.MessageType = fastReflection_QueryValidatorsResponse_Validator_messageType{}

type fastReflection_QueryValidatorsResponse_Validator_messageType struct{}

func (x fastReflection_QueryValidatorsResponse_Validator_messageType) Zero() protoreflect.Message {
	return (*fastReflection_QueryValidatorsResponse_Validator)(nil)
}
func (x fastReflection_QueryValidatorsResponse_Validator_messageType) New() protoreflect.Message {
	return new(fastReflection_QueryValidatorsResponse_Validator)
}
func (x fastReflection_QueryValidatorsResponse_Validator_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_QueryValidatorsResponse_Validator
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_QueryValidatorsResponse_Validator) Descriptor() protoreflect.MessageDescriptor {
	return md_QueryValidatorsResponse_Validator
}
...
// type information. If the Go type information is not needed,
// it is recommended that the message descriptor be used instead.
func (x *fastReflection_QueryValidatorsResponse_Validator) Type() protoreflect.MessageType {
	return _fastReflection_QueryValidatorsResponse_Validator_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_QueryValidatorsResponse_Validator) New() protoreflect.Message {
	return new(fastReflection_QueryValidatorsResponse_Validator)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_QueryValidatorsResponse_Validator) Interface() protoreflect.ProtoMessage {
	return (*QueryValidatorsResponse_Validator)(x)
}
...
// While iterating, mutating operations may only be performed
// on the current field descriptor.
func (x *fastReflection_QueryValidatorsResponse_Validator) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.Address != "" {
		value := protoreflect.ValueOfString(x.Address)
		if !f(fd_QueryValidatorsResponse_Validator_address, value) {
			return
		}
	}
	if x.Metadata != "" {
		value := protoreflect.ValueOfString(x.Metadata)
		if !f(fd_QueryValidatorsResponse_Validator_metadata, value) {
			return
		}
	}
	if x.MissedBlocks != int64(0) {
		value := protoreflect.ValueOfInt64(x.MissedBlocks)
		if !f(fd_QueryValidatorsResponse_Validator_missed_blocks, value) {
			return
		}
	}
}
...
// a proto3 scalar field is populated if it contains a non-zero value, and
// a repeated field is populated if it is non-empty.
func (x *fastReflection_QueryValidatorsResponse_Validator) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "chora.validator.v1.QueryValidatorsResponse.Validator.address":
		return x.Address != ""
	case "chora.validator.v1.QueryValidatorsResponse.Validator.metadata":
		return x.Metadata != ""
	case "chora.validator.v1.QueryValidatorsResponse.Validator.missed_blocks":
		return x.MissedBlocks != int64(0)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: chora.validator.v1.QueryValidatorsResponse.Validator"))
		}
		panic(fmt.Errorf("message chora.validator.v1.QueryValidatorsResponse.Validator does not contain field %s", fd.FullName()))
	}
}
...
//
// Clear is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryValidatorsResponse_Validator) Clear(fd protoreflect.FieldDescriptor) {
	switch fd.FullName() {
	case "chora.validator.v1.QueryValidatorsResponse.Validator.address":
		x.Address = ""
	case "chora.validator.v1.QueryValidatorsResponse.Validator.metadata":
...
// For unpopulated composite types, it returns an empty, read-only view
// of the value; to obtain a mutable reference, use Mutable.
func (x *fastReflection_QueryValidatorsResponse_Validator) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	switch descriptor.FullName() {
	case "chora.validator.v1.QueryValidatorsResponse.Validator.address":
		value := x.Address
		return protoreflect.ValueOfString(value)
	...
	default:
		...
		panic(fmt.Errorf("message chora.validator.v1.QueryValidatorsResponse.Validator does not contain field %s", descriptor.FullName()))
	}
}
...
//
// Set is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryValidatorsResponse_Validator) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	case "chora.validator.v1.QueryValidatorsResponse.Validator.address":
		x.Address = value.Interface().(string)
	case "chora.validator.v1.QueryValidatorsResponse.Validator.metadata":
...
//
// Mutable is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryValidatorsResponse_Validator) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "chora.validator.v1.QueryValidatorsResponse.Validator.address":
		panic(fmt.Errorf("field address of message chora.validator.v1.QueryValidatorsResponse.Validator is not mutable"))
	case "chora.validator.v1.QueryValidatorsResponse.Validator.metadata":
		panic(fmt.Errorf("field metadata of message chora.validator.v1.QueryValidatorsResponse.Validator is not mutable"))
	case "chora.validator.v1.QueryValidatorsResponse.Validator.missed_blocks":
		panic(fmt.Errorf("field missed_blocks of message chora.validator.v1.QueryValidatorsResponse.Validator is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: chora.validator.v1.QueryValidatorsResponse.Validator"))
		}
...
// for the given descriptor. For scalars, this returns the default value.
// For lists, maps, and messages, this returns a new, empty, mutable value.
func (x *fastReflection_QueryValidatorsResponse_Validator) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "chora.validator.v1.QueryValidatorsResponse.Validator.address":
		return protoreflect.ValueOfString("")
	case "chora.validator.v1.QueryValidatorsResponse.Validator.metadata":
...
// returning nil if none are populated.
// It panics if the oneof descriptor does not belong to this message.
func (x *fastReflection_QueryValidatorsResponse_Validator) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in chora.validator.v1.QueryValidatorsResponse.Validator", d.FullName()))
	}
	panic("unreachable")
}
...
// The caller may only mutate the contents of the RawFields
// if the mutated bytes are stored back into the message with SetUnknown.
func (x *fastReflection_QueryValidatorsResponse_Validator) GetUnknown() protoreflect.RawFields {
	return x.unknownFields
}
...
//
// SetUnknown is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryValidatorsResponse_Validator) SetUnknown(fields protoreflect.RawFields) {
	x.unknownFields = fields
}
...
// Validity is not part of the protobuf data model, and may not
// be preserved in marshaling or other operations.
func (x *fastReflection_QueryValidatorsResponse_Validator) IsValid() bool {
	return x != nil
}
...
// "google.golang.org/protobuf/runtime/protoiface".Methods.
// Consult the protoiface package documentation for details.
func (x *fastReflection_QueryValidatorsResponse_Validator) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*QueryValidatorsResponse_Validator)
		if x == nil {
			return protoiface.SizeOutput{
				NoUnkeyedLiterals: input.NoUnkeyedLiterals,
				Size:              0,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			wireType := int(wire & 0x7)
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: QueryValidatorsResponse_Validator: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: QueryValidatorsResponse_Validator: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			case 1:
				if wireType != 2 {
...
func (*QueryValidatorRequest) Descriptor() ([]byte, []int) {
	return file_chora_validator_v1_query_proto_rawDescGZIP(), []int{2}
}
...
func (*QueryValidatorResponse) Descriptor() ([]byte, []int) {
	return file_chora_validator_v1_query_proto_rawDescGZIP(), []int{3}
}
...
func (*QueryValidatorsRequest) Descriptor() ([]byte, []int) {
	return file_chora_validator_v1_query_proto_rawDescGZIP(), []int{4}
}
...
func (*QueryValidatorsResponse) Descriptor() ([]byte, []int) {
	return file_chora_validator_v1_query_proto_rawDescGZIP(), []int{5}
}

func (x *QueryValidatorsResponse) GetValidators() []*QueryValidatorsResponse_Validator {
	if x != nil {
		return x.Validators
	}
	return nil
...
func (x *QueryValidatorsResponse_Validator) Reset() {
	*x = QueryValidatorsResponse_Validator{}
	if protoimpl.UnsafeEnabled {
		mi := &file_chora_validator_v1_query_proto_msgTypes[6]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
...
func (x *QueryValidatorsResponse_Validator) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (*QueryValidatorsResponse_Validator) Descriptor() ([]byte, []int) {
	return file_chora_validator_v1_query_proto_rawDescGZIP(), []int{5, 0}
}
...
var file_chora_validator_v1_query_proto_rawDesc = []byte{
	...
	0x72, 0x2e, 0x76, 0x31, 0x1a, 0x2a, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2f, 0x62, 0x61, 0x73,
	...
	,
	...
	0x76, 0x31, 0x2f, 0x76, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x6f, 0x72, 0x73, 0x42, 0xd5, 0x01,
	0x0a, 0x16, 0x63, 0x6f, 0x6d, 0x2e, 0x63, 0x68, 0x6f, 0x72, 0x61, 0x2e, 0x76, 0x61, 0x6c, 0x69,
	0x64, 0x61, 0x74, 0x6f, 0x72, 0x2e, 0x76, 0x31, 0x42, 0x0a, 0x51, 0x75, 0x65, 0x72, 0x79, 0x50,
	...
	,
}

var (
	file_chora_validator_v1_query_proto_rawDescOnce sync.Once
	file_chora_validator_v1_query_proto_rawDescData = file_chora_validator_v1_query_proto_rawDesc
)

func file_chora_validator_v1_query_proto_rawDescGZIP() []byte {
	file_chora_validator_v1_query_proto_rawDescOnce.Do(func() {
		file_chora_validator_v1_query_proto_rawDescData = protoimpl.X.CompressGZIP(file_chora_validator_v1_query_proto_rawDescData)
	})
	return file_chora_validator_v1_query_proto_rawDescData
}
...
var file_chora_validator_v1_query_proto_goTypes = []interface{}{
	...
	(*QueryValidatorsResponse)(nil),           // 5: chora.validator.v1.QueryValidatorsResponse
	(*QueryValidatorsResponse_Validator)(nil), // 6: chora.validator.v1.QueryValidatorsResponse.Validator
...
var file_chora_validator_v1_query_proto_depIdxs = []int32{
...
func init() { file_chora_validator_v1_query_proto_init() }
func file_chora_validator_v1_query_proto_init() {
	if File_chora_validator_v1_query_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		...
		file_chora_validator_v1_query_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_chora_validator_v1_query_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_chora_validator_v1_query_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_chora_validator_v1_query_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_chora_validator_v1_query_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*QueryValidatorsResponse_Validator); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_chora_validator_v1_query_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   7,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_chora_validator_v1_query_proto_goTypes,
		DependencyIndexes: file_chora_validator_v1_query_proto_depIdxs,
		MessageInfos:      file_chora_validator_v1_query_proto_msgTypes,
	}.Build()
	File_chora_validator_v1_query_proto = out.File
	file_chora_validator_v1_query_proto_rawDesc = nil
	file_chora_validator_v1_query_proto_goTypes = nil
	file_chora_validator_v1_query_proto_depIdxs = nil
}

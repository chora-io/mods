...
func init() {
	file_chora_content_v1_events_proto_init()
	md_EventUpdate = File_chora_content_v1_events_proto.Messages().ByName("EventUpdate")
...
func (x *fastReflection_EventUpdate) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "chora.content.v1.EventUpdate.id":
		return x.Id != uint64(0)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: chora.content.v1.EventUpdate"))
		}
		panic(fmt.Errorf("message chora.content.v1.EventUpdate does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_EventUpdate) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message chora.content.v1.EventUpdate does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_EventUpdate) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "chora.content.v1.EventUpdate.id":
		panic(fmt.Errorf("field id of message chora.content.v1.EventUpdate is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: chora.content.v1.EventUpdate"))
		}
...
func (x *fastReflection_EventUpdate) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in chora.content.v1.EventUpdate", d.FullName()))
	}
	panic("unreachable")
}
...
// EventUpdate is an event emitted when content is updated.
...
var file_chora_content_v1_events_proto_rawDesc = []byte{
	...
	0x1d, 0x0a, 0x0b, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x12, 0x0e,
	0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x04, 0x52, 0x02, 0x69, 0x64, 0x42, 0xc0,
	0x01, 0x0a, 0x14, 0x63, 0x6f, 0x6d, 0x2e, 0x63, 0x68, 0x6f, 0x72, 0x61, 0x2e, 0x63, 0x6f, 0x6e,
	0x74, 0x65, 0x6e, 0x74, 0x2e, 0x76, 0x31, 0x42, 0x0b, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x73, 0x50,
	0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x39, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63,
	0x6f, 0x6d, 0x2f, 0x63, 0x68, 0x6f, 0x72, 0x61, 0x69, 0x6f, 0x2f, 0x63, 0x6f, 0x6e, 0x74, 0x65,
...
var file_chora_content_v1_events_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_chora_content_v1_events_proto_goTypes = []interface{}{
	(*EventCreate)(nil), // 0: chora.content.v1.EventCreate
	(*EventUpdate)(nil), // 1: chora.content.v1.EventUpdate
	(*EventDelete)(nil), // 2: chora.content.v1.EventDelete
}

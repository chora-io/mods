...
func init() {
	proto.RegisterType((*QueryInterchainAccountRequest)(nil), "chora.intertx.v1.QueryInterchainAccountRequest")
	proto.RegisterType((*QueryInterchainAccountResponse)(nil), "chora.intertx.v1.QueryInterchainAccountResponse")
}
...
var fileDescriptor_0801432bccbe1b86 = []byte{
	...
	,
}
...
func (c *queryClient) InterchainAccount(ctx context.Context, in *QueryInterchainAccountRequest, opts ...grpc.CallOption) (*QueryInterchainAccountResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/chora.intertx.v1.Query/InterchainAccount", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_InterchainAccount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/chora.intertx.v1.Query/InterchainAccount",
	}
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "chora.intertx.v1.Query",

...
var (
	pattern_Query_InterchainAccount_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4, 1, 0, 4, 1, 5, 5}, []string{"chora", "intertx", "v1", "interchain-account", "owner", "connection_id"}, "", runtime.AssumeColonVerbOpt(false)))
)
